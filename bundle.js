...
var _run = (0, _core.run)(_app2.default, drivers);

var sinks = _run.sinks;
var sources = _run.sources;
...
},{"./src/app":64,"@cycle/core":2,"@cycle/dom":3}],2:[function(require,module,exports){
"use strict";
...
},{"rx":25}],3:[function(require,module,exports){
"use strict";
...
},{"rx":25}],5:[function(require,module,exports){
'use strict';
...
},{"./fromevent":4,"./transposition":8,"./virtual-hyperscript":10,"matches-selector":23,"rx":25,"vdom-parser":30,"virtual-dom/diff":37,"virtual-dom/patch":38}],7:[function(require,module,exports){
"use strict";
...
},{"./transposition":8,"rx":25,"vdom-to-html":34}],8:[function(require,module,exports){
"use strict";
...
},{"rx":25,"virtual-dom/vnode/vnode":57}],9:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":10,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":45,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":49,"x-is-array":62}],10:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":46,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":47,"virtual-dom/virtual-hyperscript/parse-tag.js":48,"virtual-dom/vnode/is-thunk":51,"virtual-dom/vnode/is-vhook":52,"virtual-dom/vnode/is-vnode":53,"virtual-dom/vnode/is-vtext":54,"virtual-dom/vnode/is-widget":55,"virtual-dom/vnode/vnode.js":57,"virtual-dom/vnode/vtext.js":59,"x-is-array":62}],11:[function(require,module,exports){
...
},{"./property-config":35,"escape-html":14}],34:[function(require,module,exports){
var escape = require('escape-html');
...
},{"../vnode/is-vhook.js":52,"is-object":20}],40:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":50,"../vnode/is-vnode.js":53,"../vnode/is-vtext.js":54,"../vnode/is-widget.js":55,"./apply-properties":39,"global/document":16}],41:[function(require,module,exports){
...
},{"./create-element":40,"./dom-index":41,"./patch-op":42,"global/document":16,"x-is-array":62}],44:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":15}],47:[function(require,module,exports){
'use strict';
...
},{"browser-split":12}],49:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":52,"is-object":20}],61:[function(require,module,exports){
var isArray = require("x-is-array")
...
var _seed_grid = require('./seed_grid');

var _seed_grid2 = _interopRequireDefault(_seed_grid);

var _update_grid = require('./update_grid');
...
function updateGridReducer(e) {
  return function updateGridState(state) {
    return Object.assign({}, state, { grid: (0, _update_grid2.default)(state.grid) });
  };
}
...
exports.default = getNeighbouringCellPositions;
function getNeighbouringCellPositions(grid, cellPosition) {
  var coordinates = [{ row: -1, column: -1 }, // top-left
  ...
  var gridBounaries = { width: grid[0].length, height: grid.length };

  var cellPositions = coordinates.map(function (coordinate) {
...
exports.default = seedGrid;
function seedGrid(grid) {
  var probability = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
...
var _get_neighbouring_cells = require('./get_neighbouring_cells');

var _get_neighbouring_cells2 = _interopRequireDefault(_get_neighbouring_cells);
...
function updateCell(grid, cellPosition) {
  ...
  var aliveNeighbours = neighbourStatuses.filter(function (status) {
    return status === true;
  });
...
var _update_cell = require('./update_cell');

var _update_cell2 = _interopRequireDefault(_update_cell);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function updateGrid(grid) {
  var updatedGrid = grid.map(function (row, rowIndex) {
    return row.map(function (cell, columnIndex) {
      return (0, _update_cell2.default)(grid, { row: rowIndex, column: columnIndex });
    });
  });
